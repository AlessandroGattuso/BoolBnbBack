                        ...
                        <div class="col-12 position-relative">
                            ...
                            <div class="row mt-2 me-3">
                                <div class="col-12 col-md-3 mb-2 d-flex">
												{{-- link alla pagina delle views --}}
                                    <a href="{{ route('admin.views.index'), $apartment->id }}" class="fw-bold mt-2 ms-4 position-absolute top-0 start-0" mb-2><span class="badge bg_color_light_blue"><i class="fa-solid fa-chart-simple"></i> {{count($apartment_views) > 0 ? count($apartment_views) : 'Nessun utente ha visualizzato il tuo apprtamento' }}</span></a>

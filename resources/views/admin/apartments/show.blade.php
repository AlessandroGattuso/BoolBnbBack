...
@section('content')
    <div class="container pb-3">
        <div class="col-12 col-md-9 d-flex">
            <a href="{{ route('admin.apartments.index') }}" role="button"><i class="fa-solid fa-circle-arrow-left fs-3 me-2 mt-2 btn-hover" style="color: #3a92d1"></i></a>
            ...
            <div class="col-12 col-md-6">
                <div class="row">
                        ...
                        <div class="col-12 position-relative">
                            ...
                            <div class="row mt-2 me-3 position-absolute bottom-0 end-0">
                                <div class="col-12 col-md-3 d-flex mb-2">
                        ...
                        <div class="row mt-2">  
                            <div class="col-12 mb-2">
                                <h5 class="fw-bold m-0" mb-2><span class="badge bg_color_light_blue"><i class="fa-solid fa-eye me-2"></i> {{count($apartment_views) > 0 ? count($apartment_views) : 'Nessun utente ha visualizzato il tuo apprtamento' }}</span></h5>
                            </div>
                        </div>
                        <hr>
                        <h5 class="fw-bold d-flex justify-content-between">Prezzo <span>&euro; {{ $apartment->prezzo ? $apartment->prezzo : 'Non specificato' }}<span class="fw-light fs-6"> / notte</span></span></h5>
                        <hr>
                        <!-- Servizi -->
